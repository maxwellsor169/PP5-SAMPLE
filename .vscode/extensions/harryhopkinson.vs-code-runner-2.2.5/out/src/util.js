...
exports.UtilityGetConfiguration = UtilityGetConfiguration;
        ...
        try {
            ...
            if (usingNewInterpreterStorage) {
                ...
                const execCommand = extension.exports.settings.getExecutionDetails
                    ? extension.exports.settings.getExecutionDetails(document === null || document === void 0 ? void 0 : document.uri)
                        .execCommand
                ...
                return UtilityGetConfiguration("python", document).get("pythonPath");
            }
        }
        catch (error) {
            return constants_1.Constants.python;
...
function UtilityGetConfiguration(section, document) {
    if (document) {
